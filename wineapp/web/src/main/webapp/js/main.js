...
var webApp = function() {
	...
	var fbValidate = function(fbResponse) {
		console.log('Welcome!  Fetching your information.... ' + fbResponse);
		console.log('AccessToken -> ' + fbResponse.authResponse.accessToken);
